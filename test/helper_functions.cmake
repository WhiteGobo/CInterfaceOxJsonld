...
function(configure_toRdfTest basePath baseIri testdata_json testsuffix)
	...
	if(internetAccess)
		get_property(tmp_labels TEST "${testname}" PROPERTY LABELS)
		list(APPEND tmp_labels "RequiresInternetAccess")
		set_property(TEST "${testname}" PROPERTY LABELS "${tmp_labels}")
	endif()
endfunction()
